...
export const registerCode: CodeConfig = {
  ...
  pendingHighlights: [[1], [3, 4], [6, 7], [9, 10], [12, 13, 14], [16]],
  successHighlights: [[16], [17, 18], [20]],
...
export const logoutCode: CodeConfig = {
  ...
  pendingHighlights: [[1], [1], [3]],
  successHighlights: [[3], [4]],
  errorHighlights: [3],
};
...
export const changePasswordCode: CodeConfig = {
  ...
  pendingHighlights: [[1], [3, 4], [6, 7], [9, 10], [12, 13]],
  successHighlights: [[15], [16], [18]],
...
export const deleteCode: CodeConfig = {
  ...
  pendingHighlights: [[1], [3, 4], [6, 7, 9, 10]],
  successHighlights: [[13], [15]],
  errorHighlights: [3, 4],
};
